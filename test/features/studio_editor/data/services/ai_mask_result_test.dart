...
void main() {
  group('buildAiMaskResult', () {
    test('accepts a centered high-confidence subject mask', () {
      ...
      final result = buildAiMaskResult(
        width: width,
        height: height,
      ...
      expect(result.isReliableForAutomation, isTrue);
    });

    test('rejects whole-frame masks from automatic isolation', () {
      const width = 10;
      const height = 10;
      ...
      expect(result.isReliableForAutomation, isFalse);
    });
  });
}
