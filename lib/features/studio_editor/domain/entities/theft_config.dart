class TheftConfig {
  ...
  TheftConfig sanitized() {
    return TheftConfig(
      strength: strength.clamp(0.0, 0.88).toDouble(),
      skinProtect: skinProtect.clamp(0.35, 1.0).toDouble(),
      lumaTransfer: lumaTransfer.clamp(0.0, 0.72).toDouble(),
      colorTransfer: colorTransfer.clamp(0.0, 0.92).toDouble(),
      contrastBoost: contrastBoost.clamp(0.88, 1.18).toDouble(),
      vignette: vignette.clamp(0.0, 0.18).toDouble(),
      grain: grain.clamp(0.0, 0.08).toDouble(),
