  ...
  Widget build(BuildContext context) => InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(
                  color:
                      active ? color.withValues(alpha: .48) : Colors.white10)),
...
class LumaSearchBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) => TextField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: const Icon(Icons.search_rounded, color: AppTokens.text3),
          suffixIcon: controller.text.isEmpty
              ? null
              : IconButton(
                  onPressed: controller.clear,
                  icon: const Icon(Icons.close_rounded, color: AppTokens.text3),
                ),
          filled: true,
          ...
          focusedBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(
                  color: AppTokens.primary.withValues(alpha: .70), width: 1.2)),
        ),
      );
}
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        SliderTheme(
          data: SliderTheme.of(context).copyWith(
              ...
              overlayColor: AppTokens.primary.withValues(alpha: .10),
              trackHeight: 4,
